...
async def websocket_endpoint(websocket: WebSocket):
    ...
    fid = None
    auth_time = None  # Track authentication time
    session_timeout = 330 # 360  # 6 minutes in seconds
    ...
    def is_session_expired() -> bool:
        """Check if 6 minutes have passed since authentication"""
    ...
    try:
        ...
        try:
            ...
            if resp:
                auth_time = time.time()  # Record authentication time
    ...
    async def auto_close_after_timeout():
        """Automatically close WebSocket after 6 minutes"""
        try:
    ...
    try:
        ...
        while True:
            # Check if session has expired before processing messages
            if is_session_expired():
